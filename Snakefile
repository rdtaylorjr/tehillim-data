# One command regenerates the whole project: representations, benchmarks, front-end payloads.
...
rule all:
    ...
    shell:
        ...
        " --genre-csv {GENRE_CSV} --ui-root {UI_ROOT} --workers {WORKERS} --log-root {HERE}/logs"
